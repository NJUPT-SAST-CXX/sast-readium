...
public:
    ...
    void setDocumentController(DocumentController* controller) { m_documentController = controller; }
    void setPageController(PageController* controller) { m_pageController = controller; }
    ...
    std::unique_ptr<DocumentCommand> createOpenCommand(const QString& filePath = QString());
    std::unique_ptr<DocumentCommand> createCloseCommand(int index = -1);
    std::unique_ptr<DocumentCommand> createSaveAsCommand(const QString& targetPath = QString());
    ...
    std::unique_ptr<NavigationCommand> createNavigationCommand(const QString& type);
    ...
    std::unique_ptr<NavigationCommand> createViewModeCommand(const QString& mode);
