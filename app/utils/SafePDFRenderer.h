...
/**
 * @brief Safe PDF rendering utilities with defensive programming and Qt PDF
 * compatibility handling
 *
 * This class provides safe wrappers around Poppler's renderToImage() function
 * to prevent segmentation faults when dealing with Qt-generated PDFs (created
 * with QPdfWriter). Qt-generated PDFs can cause crashes in libpoppler-qt6-3.dll
...
public:
    ...
    enum class CompatibilityResult {
        ...
        QtGenerated,  ///< PDF was likely generated by Qt (QPdfWriter) - high
                      ///< risk
    ...
    /**
     * @brief Safely render a PDF page to image with comprehensive error
     * handling
     ...
     */
    QImage safeRenderPage(Poppler::Page* page, double dpi,
     ...
     */
    QPixmap safeRenderPageToPixmap(Poppler::Page* page, double dpi,
                                   RenderInfo* info = nullptr);
     ...
     * @return Rendered image, or null image if rendering fails
     */
    QImage safeRenderPageRegion(Poppler::Page* page, const QRectF& region,
                                double dpi, RenderInfo* info = nullptr);
     ...
     */
    QImage createPlaceholderImage(const QSize& size,
...
private:
     ...
     */
    QImage safeRenderPageInternal(Poppler::Page* page, double dpi,
                                  const QRectF& region, RenderInfo* info);

    /**
     * @brief Try rendering with low DPI as fallback
     */
    QImage tryLowDpiRender(Poppler::Page* page, const QRectF& region,
                           RenderInfo* info);
     ...
     */
    QImage threadSafeRender(Poppler::Page* page, double dpi,
                            const QRectF& region);
