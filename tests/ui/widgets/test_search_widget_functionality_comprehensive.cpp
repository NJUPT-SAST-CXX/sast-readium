...
void SearchWidgetFunctionalityTest::initTestCase() {
...
void SearchWidgetFunctionalityTest::testSearchValidation() {
    QLineEdit* searchInput = getSearchInput();
    if (!searchInput) {
        QSKIP("Search input not found");
    }
...
void SearchWidgetFunctionalityTest::testCaseSensitiveOption() {
...
void SearchWidgetFunctionalityTest::testRegularExpressionOption() {
...
void SearchWidgetFunctionalityTest::testSearchDirectionOption() {
...
void SearchWidgetFunctionalityTest::testNavigationShortcuts() {
    QLineEdit* searchInput = getSearchInput();
    if (!searchInput) {
        QSKIP("Search input not found");
    }
