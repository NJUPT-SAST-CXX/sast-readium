...
void T estToolBarFunctionalityComprehensive::testPageNavigationActions() {
    QSignalSpy actionSpy(m_toolbar, &ToolBar::actionTriggered);
...
v oid TestToolBarFunctionalityComprehensive::testZoomActions() {
    QSignalSpy actionSpy(m_toolbar, &ToolBar::actionTriggered);
...
v oid TestToolBarFunctionalityComprehensive::testSidebarToggle() {
    QSignalSpy actionSpy(m_toolbar, &ToolBar::actionTriggered);
...
voi d TestToolBarFunctionalityComprehensive::testToolbarEnableDisable() {
...
Helper method implementations QAction*
TestToolBarFunctionalityComprehensive::findActionByName(const QString& name) {
    QList<QAction*> actions = m_toolbar->actions();
    for (QAction* action : actions) {
