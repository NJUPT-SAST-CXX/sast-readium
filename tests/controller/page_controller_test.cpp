...
public:
    ...
    // Override validation methods to bypass render model requirements for testing
    ...
    bool isDocumentValid() const override {
        return hasDocument();
    }
...
private slots:
    ...
    void testGoToNextPage() {
        QSignalSpy pageChangedSpy(m_pageController, &PageController::pageChanged);
    ...
    void testNavigationHistory() {
        ...
        QSignalSpy navStateSpy(m_pageController, &PageController::navigationStateChanged);
    ...
    void testAddBookmark() {
        QSignalSpy bookmarkAddedSpy(m_pageController, &PageController::bookmarkAdded);
        QSignalSpy bookmarksChangedSpy(m_pageController, &PageController::bookmarksChanged);
    ...
    void testRemoveBookmark() {
        ...
        QSignalSpy bookmarkRemovedSpy(m_pageController, &PageController::bookmarkRemoved);
        QSignalSpy bookmarksChangedSpy(m_pageController, &PageController::bookmarksChanged);
    ...
    void testSetZoomLevel() {
        QSignalSpy zoomChangedSpy(m_pageController, &PageController::zoomChanged);
    ...
    void testSetRotation() {
        QSignalSpy rotationChangedSpy(m_pageController, &PageController::rotationChanged);
