...
private slots:
    ...
    void testRegisterServiceFactory() {
        ...
        ServiceLocator::instance().registerService<ITestService, TestServiceImpl>();
    ...
    void testRegisterSharedService() {
        ...
        auto retrieved = ServiceLocator::instance().getSharedService<ITestService>();
        QVERIFY(retrieved != nullptr);
    ...
    void testClearServices() {
        ...
        ServiceLocator::instance().registerService<ITestService>(new TestServiceImpl());
