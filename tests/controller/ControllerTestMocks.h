...
public:
    ...
    void setDpi(int dpiX, int dpiY) { m_dpiX = dpiX; m_dpiY = dpiY; }
...
public:
    ...
    // Mock for getCurrentDocument - returns nullptr since we can't create real Poppler::Document
...
public:
    ...
    // Test helpers
    void reset() { m_currentPage = 1; m_totalPages = 1; }
...
public:
    ...
    void setAvailableThemes(const QStringList& themes) { m_availableThemes = themes; }
...
public:
    // File system helpers
    static QString createTempPdfFile(const QString& content = "Mock PDF Content");
    ...
    template<typename T>
    static bool waitForSignal(T* object, const char* signal, int timeout = 5000) {
...
public:
    ...
    static MockDocumentModel* createMockDocumentModel(QObject* parent = nullptr);
    static MockPageModel* createMockPageModel(int totalPages = 10, QObject* parent = nullptr);
    static MockRenderModel* createMockRenderModel(int dpiX = 96, int dpiY = 96, QObject* parent = nullptr);
    static MockRecentFilesManager* createMockRecentFilesManager(QObject* parent = nullptr);
    static MockStyleManager* createMockStyleManager(QObject* parent = nullptr);
    static MockWelcomeScreenManager* createMockWelcomeScreenManager(QObject* parent = nullptr);
