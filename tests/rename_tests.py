...
TEST_FILES_TO_RENAME = [
    ...
    ("controller/ApplicationControllerTest.cpp", "controller/application_controller_test.cpp"),
    ("controller/ConfigurationManagerTest.cpp", "controller/configuration_manager_test.cpp"),
    ("controller/DocumentControllerTest.cpp", "controller/document_controller_test.cpp"),
    ...
    ("command/InitializationCommandTest.cpp", "command/initialization_command_test.cpp"),
