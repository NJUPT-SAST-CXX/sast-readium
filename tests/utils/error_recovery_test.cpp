...
void ErrorRecoveryTest::testRetryPolicyEnum() {
    ...
    QVERIFY(ErrorRecovery::RetryPolicy::None != ErrorRecovery::RetryPolicy::Immediate);
    QVERIFY(ErrorRecovery::RetryPolicy::Immediate != ErrorRecovery::RetryPolicy::FixedDelay);
    QVERIFY(ErrorRecovery::RetryPolicy::FixedDelay != ErrorRecovery::RetryPolicy::ExponentialBackoff);
    QVERIFY(ErrorRecovery::RetryPolicy::ExponentialBackoff != ErrorRecovery::RetryPolicy::LinearBackoff);
}
...
void ErrorRecoveryTest::testFallbackStrategyEnum() {
    // Test that all enum values are distinct
    QVERIFY(ErrorRecovery::FallbackStrategy::None != ErrorRecovery::FallbackStrategy::DefaultValue);
    QVERIFY(ErrorRecovery::FallbackStrategy::DefaultValue != ErrorRecovery::FallbackStrategy::CachedValue);
    QVERIFY(ErrorRecovery::FallbackStrategy::CachedValue != ErrorRecovery::FallbackStrategy::AlternativeMethod);
    QVERIFY(ErrorRecovery::FallbackStrategy::AlternativeMethod != ErrorRecovery::FallbackStrategy::GracefulDegradation);
    QVERIFY(ErrorRecovery::FallbackStrategy::GracefulDegradation != ErrorRecovery::FallbackStrategy::UserPrompt);
}

void ErrorRecoveryTest::testRecoveryResultEnum() {
    // Test that all enum values are distinct
    QVERIFY(ErrorRecovery::RecoveryResult::Success != ErrorRecovery::RecoveryResult::Failed);
    QVERIFY(ErrorRecovery::RecoveryResult::Failed != ErrorRecovery::RecoveryResult::Retry);
    QVERIFY(ErrorRecovery::RecoveryResult::Retry != ErrorRecovery::RecoveryResult::Fallback);
    QVERIFY(ErrorRecovery::RecoveryResult::Fallback != ErrorRecovery::RecoveryResult::Abort);
}
...
void ErrorRecoveryTest::testRecoveryContextConstructor() {
    ...
    ErrorRecovery::RecoveryContext context(error, "TestComponent", "TestOperation");
...
void ErrorRecoveryTest::testRecoveryManagerSingleton() {
    ErrorRecovery::RecoveryManager& manager1 = ErrorRecovery::RecoveryManager::instance();
    ErrorRecovery::RecoveryManager& manager2 = ErrorRecovery::RecoveryManager::instance();
...
int ErrorRecoveryTest::successFunction() {
    return 42;
}
