...
void ErrorHandlingTest::testErrorCategoryEnum() {
    ...
    QVERIFY(ErrorHandling::ErrorCategory::FileSystem != ErrorHandling::ErrorCategory::Document);
    QVERIFY(ErrorHandling::ErrorCategory::Document != ErrorHandling::ErrorCategory::Rendering);
    QVERIFY(ErrorHandling::ErrorCategory::Rendering != ErrorHandling::ErrorCategory::Search);
    QVERIFY(ErrorHandling::ErrorCategory::Search != ErrorHandling::ErrorCategory::Cache);
    QVERIFY(ErrorHandling::ErrorCategory::Cache != ErrorHandling::ErrorCategory::Network);
    QVERIFY(ErrorHandling::ErrorCategory::Network != ErrorHandling::ErrorCategory::Threading);
    QVERIFY(ErrorHandling::ErrorCategory::Threading != ErrorHandling::ErrorCategory::UI);
    QVERIFY(ErrorHandling::ErrorCategory::UI != ErrorHandling::ErrorCategory::Plugin);
    QVERIFY(ErrorHandling::ErrorCategory::Plugin != ErrorHandling::ErrorCategory::Configuration);
    QVERIFY(ErrorHandling::ErrorCategory::Configuration != ErrorHandling::ErrorCategory::Memory);
    QVERIFY(ErrorHandling::ErrorCategory::Memory != ErrorHandling::ErrorCategory::Unknown);
}

void ErrorHandlingTest::testCategoryToString() {
    QCOMPARE(ErrorHandling::categoryToString(ErrorHandling::ErrorCategory::FileSystem), "FileSystem");
    QCOMPARE(ErrorHandling::categoryToString(ErrorHandling::ErrorCategory::Document), "Document");
    QCOMPARE(ErrorHandling::categoryToString(ErrorHandling::ErrorCategory::Rendering), "Rendering");
    QCOMPARE(ErrorHandling::categoryToString(ErrorHandling::ErrorCategory::Search), "Search");
    QCOMPARE(ErrorHandling::categoryToString(ErrorHandling::ErrorCategory::Cache), "Cache");
    QCOMPARE(ErrorHandling::categoryToString(ErrorHandling::ErrorCategory::Network), "Network");
    QCOMPARE(ErrorHandling::categoryToString(ErrorHandling::ErrorCategory::Threading), "Threading");
    QCOMPARE(ErrorHandling::categoryToString(ErrorHandling::ErrorCategory::UI), "UI");
    QCOMPARE(ErrorHandling::categoryToString(ErrorHandling::ErrorCategory::Plugin), "Plugin");
    QCOMPARE(ErrorHandling::categoryToString(ErrorHandling::ErrorCategory::Configuration), "Configuration");
    QCOMPARE(ErrorHandling::categoryToString(ErrorHandling::ErrorCategory::Memory), "Memory");
    QCOMPARE(ErrorHandling::categoryToString(ErrorHandling::ErrorCategory::Unknown), "Unknown");
}

void ErrorHandlingTest::testErrorSeverityEnum() {
    // Test that all enum values are distinct
    QVERIFY(ErrorHandling::ErrorSeverity::Info != ErrorHandling::ErrorSeverity::Warning);
    QVERIFY(ErrorHandling::ErrorSeverity::Warning != ErrorHandling::ErrorSeverity::Error);
    QVERIFY(ErrorHandling::ErrorSeverity::Error != ErrorHandling::ErrorSeverity::Critical);
    QVERIFY(ErrorHandling::ErrorSeverity::Critical != ErrorHandling::ErrorSeverity::Fatal);
}

void ErrorHandlingTest::testSeverityToString() {
    QCOMPARE(ErrorHandling::severityToString(ErrorHandling::ErrorSeverity::Info), "Info");
    QCOMPARE(ErrorHandling::severityToString(ErrorHandling::ErrorSeverity::Warning), "Warning");
    QCOMPARE(ErrorHandling::severityToString(ErrorHandling::ErrorSeverity::Error), "Error");
    QCOMPARE(ErrorHandling::severityToString(ErrorHandling::ErrorSeverity::Critical), "Critical");
    QCOMPARE(ErrorHandling::severityToString(ErrorHandling::ErrorSeverity::Fatal), "Fatal");
}
...
void ErrorHandlingTest::testApplicationExceptionConstructor() {
    ...
    QCOMPARE(exception.errorInfo().category, ErrorHandling::ErrorCategory::FileSystem);
    QCOMPARE(exception.errorInfo().severity, ErrorHandling::ErrorSeverity::Error);
...
void ErrorHandlingTest::testApplicationExceptionWithParameters() {
    ...
    QCOMPARE(exception.errorInfo().category, ErrorHandling::ErrorCategory::Document);
    QCOMPARE(exception.errorInfo().severity, ErrorHandling::ErrorSeverity::Critical);
...
void ErrorHandlingTest::testApplicationExceptionClone() {
    ...
    std::unique_ptr<ErrorHandling::ApplicationException> cloned(original.clone());
...
int ErrorHandlingTest::returnValue() {
    return 42;
}
...
ErrorHandling::ErrorInfo ErrorHandlingTest::createTestErrorInfo() {
    return ErrorHandling::ErrorInfo(
        ErrorHandling::ErrorCategory::Document,
        ErrorHandling::ErrorSeverity::Warning,
        "Test message",
        "Test details",
...
void ErrorHandlingTest::testResultTypeError() {
    ...
    const ErrorHandling::ErrorInfo& retrievedError = ErrorHandling::getError(result);
...
void ErrorHandlingTest::testIsSuccess() {
    ErrorHandling::Result<QString> successResult = ErrorHandling::success(QString("test"));
    ErrorHandling::Result<QString> errorResult = ErrorHandling::error<QString>(createTestErrorInfo());
...
void ErrorHandlingTest::testErrorFunction() {
    ErrorHandling::ErrorInfo errorInfo = createTestErrorInfo();
    ErrorHandling::Result<double> result = ErrorHandling::error<double>(errorInfo);
...
void ErrorHandlingTest::testSafeExecuteVoidSuccess() {
    auto result = ErrorHandling::safeExecute([this]() { voidFunction(); },
...
void ErrorHandlingTest::testSafeExecuteVoidException() {
    auto result = ErrorHandling::safeExecute([this]() { throwApplicationException(); },
                                           ErrorHandling::ErrorCategory::FileSystem,
                                           "Exception test");
...
void ErrorHandlingTest::testSafeExecuteVoidApplicationException() {
    ...
    const ErrorHandling::ErrorInfo& error = ErrorHandling::getError(result);
    QCOMPARE(error.category, ErrorHandling::ErrorCategory::FileSystem); // From the thrown exception
    QCOMPARE(error.message, "Application exception test");
}

void ErrorHandlingTest::testSafeExecuteVoidStandardException() {
    auto result = ErrorHandling::safeExecute([this]() { throwStandardException(); },
...
void ErrorHandlingTest::testSafeExecuteVoidUnknownException() {
    auto result = ErrorHandling::safeExecute([this]() { throwUnknownException(); },
...
void ErrorHandlingTest::testSafeExecuteReturnValueSuccess() {
    auto result = ErrorHandling::safeExecute([this]() { return returnValue(); },
                                           ErrorHandling::ErrorCategory::Unknown,
                                           "Return value test");
...
void ErrorHandlingTest::testSafeExecuteReturnValueException() {
    auto result = ErrorHandling::safeExecute([this]() -> int { throwStandardException(); return 0; },
                                           ErrorHandling::ErrorCategory::Cache,
